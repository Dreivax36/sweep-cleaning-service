                                        ...
                                        <div class="modal-content p-3 trans_modal_content">  <!-- Modal content-->
                                            ...
                                            <form action="{{ route('assignCleaner') }}" method="post" >
                                                ...
                                                @csrf
                                                    ...
                                                    <select name="cleaner_id[]" id="cleaner" class="form-control js-example-basic-single" data-live-search="true" style="width: 100%; max-height: 250px; overflow-y: auto;" tabindex="-1" aria-hidden="true">
