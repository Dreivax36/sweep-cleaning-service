...
<div class="row"> 
    ...
    <a class="usertypebutton" id="active" href="admin_employee_payroll">EMPLOYEE <p class="totalvalue">(63)</p></a>
    <a class="usertypebutton" href="admin_cleaner_payroll">CLEANER <p class="totalvalue">(63)</p></a>
</div>
    <div class="search">
