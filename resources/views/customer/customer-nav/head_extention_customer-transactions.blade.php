    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-light sweep-nav shadow-sm">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <a id="transactions" class="nav-link active" href="{{ url('/customer/customer_transaction') }}" role="button">Transactions</a>
            ...
            <ul class="mobile-nav sticky-bottom">
                ...
                <a class="nav-button active" href="{{ url('/customer/customer_transaction') }}">
                    <i class="fas fa-clipboard-list fas-active"></i>
                    <h6>Transactions</h6>
                </a>
