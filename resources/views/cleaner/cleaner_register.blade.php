        ...
        <div class="row row_reg">
            ...
            <form action="{{ route('cleaner.cleaner_save') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <span class="text-danger">@error('requirement'){{ $message }} @enderror</span>
                </div>
                <button type="submit" class="register_btn">Sign Up</button>
                <br>
                <a class="login_link_btn" href="{{ route('cleaner.cleaner_login') }}"> I already have an account, sign in</a>
        </div>
    </div>
</body>
</html>