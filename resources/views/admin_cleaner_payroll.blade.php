...
<div class="row"> 
    <a class="usertypebutton"  href="admin_payroll">HISTORY <p class="totalvalue">(63)</p></a>
    <a class="usertypebutton"  href="admin_employee_payroll">EMPLOYEE <p class="totalvalue">(63)</p></a>
    <a class="usertypebutton"id="active" href="admin_cleaner_payroll">CLEANER <p class="totalvalue">(63)</p></a>
</div>
    <div class="search">
        ...
        <table class="table" id="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Total Job Fee</th>
